...
from model.u2net_SA_Gate import U2NETP_SA_Gate
...
model_name = 'u2netp_SA_Gate'  # 'u2net'
...
# train阶段
# 数据集路径
data_dir = os.path.join("datasets/NGnOK/train_data" + os.sep)
# 原始图片路径
...
# 原始图片路径
images_path = "datasets/NGnOK/test_data/images/"
# 图片的标签路径
gt_dir = "datasets/NGnOK/test_data/masks/"
# 存放推理结果图片的路径
pred_dir = "datasets/NGnOK/test_data/predict_masks/"
predict_label = "datasets/NGnOK/test_data/predict_labels/"
# 存放 miou 计算结果的 图片
...
if model_name == 'u2net':
    ...
    net = U2NET(3, 5)
elif model_name == 'u2netp_SA_Gate':
    net = U2NETP_SA_Gate(3, 5)
