...
class U2NETP_SA_Gate(nn.Module):
    def __init__(self, in_ch=3, out_ch=5):
        super(U2NETP_SA_Gate, self).__init__()

        self.stage1 = RSU7(in_ch, 16, 64)
        self.pool12 = nn.MaxPool2d(2, stride=2, ceil_mode=True)
        self.sagate1 = SAGate(64)

        self.stage2 = RSU6(64, 16, 64)
        self.pool23 = nn.MaxPool2d(2, stride=2, ceil_mode=True)
        self.sagate2 = SAGate(64)

        self.stage3 = RSU5(64, 16, 64)
        self.pool34 = nn.MaxPool2d(2, stride=2, ceil_mode=True)
        self.sagate3 = SAGate(64)

        self.stage4 = RSU4(64, 16, 64)
        self.pool45 = nn.MaxPool2d(2, stride=2, ceil_mode=True)
        self.sagate4 = SAGate(64)

        self.stage5 = RSU4F(64, 16, 64)
        self.pool56 = nn.MaxPool2d(2, stride=2, ceil_mode=True)
        self.sagate5 = SAGate(64)
    ...
    def forward(self, x):
        ...
        # stage 1
        hx1 = self.stage1(hx)
        hx1 = self.sagate1(hx1)
        hx = self.pool12(hx1)

        # stage 2
        hx2 = self.stage2(hx)
        hx2 = self.sagate2(hx2)
        hx = self.pool23(hx2)

        # stage 3
        hx3 = self.stage3(hx)
        hx3 = self.sagate3(hx3)
        hx = self.pool34(hx3)

        # stage 4
        hx4 = self.stage4(hx)
        hx4 = self.sagate4(hx4)
        hx = self.pool45(hx4)

        # stage 5
        hx5 = self.stage5(hx)
        hx5 = self.sagate5(hx5)
        hx = self.pool56(hx5)
